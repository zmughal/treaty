 ...
 */
public class ConjunctiveCondition extends ComplexCondition {

	/**
	 * <p>
	 * Creates a new {@link ConjunctiveCondition}.
	 * </p>
	 */
	public ConjunctiveCondition() {
	...
	public Condition replaceResources(Map<String, Resource> resources) {
		...
		ConjunctiveCondition result;
		result = new ConjunctiveCondition();
