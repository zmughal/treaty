...
public class Tests {
	...
	public void setUp() throws Exception {
		...
		IExtension x =
				registry.getExtension("net.java.treaty.eclipse.vocabulary.java");
	...
	public void testTypes2() throws Exception {
		...
		Resource r =
				this.getResource(VOC.INSTANTIABLE_CLASS, Class1.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testTypes3() throws Exception {
		...
		Resource r =
				this.getResource(VOC.ABSTRACT_TYPE, Interface1.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testTypes4() throws Exception {
		...
		Resource r =
				this.getResource(VOC.INSTANTIABLE_CLASS, Interface1.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testTypes6() throws Exception {
		...
		Resource r =
				this.getResource(VOC.INSTANTIABLE_CLASS, Class2.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testTypes8() throws Exception {
		...
		Resource r =
				this.getResource(VOC.INSTANTIABLE_CLASS, Class3.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testTypes10() throws Exception {
		...
		Resource r =
				this.getResource(VOC.INSTANTIABLE_CLASS, Class4.class.getName());
		ExistsCondition c = new ExistsCondition();
		c.setResource(r);
		VOC.check(c);
	}
	...
	public void testRelationship3() throws Exception {
		...
		Resource r1 =
				this.getResource(VOC.INSTANTIABLE_CLASS, Class5.class.getName());
		Resource r2 = this.getResource(VOC.ABSTRACT_TYPE, Class1.class.getName());
		RelationshipCondition rel = new RelationshipCondition();
		rel.setResource1(r1);
		rel.setResource2(r2);
